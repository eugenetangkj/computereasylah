    ...
    <div>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:mx-12 space-y-8 lg:space-y-0 lg:space-x-16 py-8 z-10">
          {/* iPhone */}
          <NextLink href='/apps/backup-phone/iphone' className='w-full'>
              ...
              >
                  ...
                  <img src='/assets/apps/apple-logo.png' alt='Apple' className='w-1/4' />
              </div>
          </NextLink>

          {/* Android */}
          <NextLink href='/apps/backup-phone/android' className='w-full'>
              ...
              >
                  ...
                  <img src='/assets/apps/android-logo.png' alt='Android' className='w-1/4' />
              </div>
          </NextLink>
