  ...
  return (
    <div>
      ...
      >
        ...
        {/* Options */}
        <div className="flex flex-col md:grid lg:grid-rows-2 md:grid-cols-2 lg:grid-cols-3 md:gap-x-16 lg:gap-x-24 md:gap-y-8 justify-center items-center mx-24 space-y-4 md:space-y-0 py-4">
          {/* Typing */}
          <NextLink
            href="/typing"
