...
//Notepad complete screen component
type NotepadCompleteProps = {
...
export default function NotepadComplete({ updateCurrentElementIndex } : NotepadCompleteProps ){
  // Animation
  ...
  return ( <div className={`flex flex-col items-center justify-center min-h-screen py-2 bg-white space-y-32 lg:space-y-16 mt-10 md:mt-20 lg:mt-16 2xl:mt-0 opacity-0 transition-opacity ${
        ...
        <div className='flex justify-center items-center space-x-8'>
            ...
            {/* Exit button */}
            <NextLink href='/apps/common-apps'>
