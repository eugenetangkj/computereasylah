...
export default function NotepadTheory({ updateCurrentElementIndex } : NotepadTheoryProps ){
  // Animation
  ...
  return ( <div className={`flex flex-col items-center justify-center min-h-screen py-2 bg-white space-y-12 lg:space-y-8 mt-10 md:mt-20 lg:mt-8 2xl:mt-0 opacity-0 transition-opacity ${
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center space-y-4 lg:space-x-16 lg:space-y-0 mt-16">
            <h1 className="text-5xl md:text-6xl lg:text-7xl 2xl:text-8xl font-bold font-gaegu text-center">Notepad</h1>
