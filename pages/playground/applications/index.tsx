...
export default function Applications() {
  ...
  return (
    ...
    >
      ...
      {/* Back button */}
      <BackButton pathToReturnTo='/playground' displayText='Back' category={Topic.Applications} />
      ...
      <div className="flex flex-col lg:grid lg:grid-rows-2 lg:grid-cols-2 justify-center items-center mx-24 lg:mx-12 space-y-8 lg:space-y-0 lg:gap-y-8 lg:gap-x-32 2xl:gap-y-16 py-4">
        ...
        {/* Background Images */}
        <img src='/assets/applications/terminal-interface.png' alt='Video' className='w-1/4 md:w-1/6 lg:w-1/8 fixed top-0 right-0 translate-x-3/10 z-20' />
