  ...
  return (
    <div>
      ...
      >
        ...
        {/* Title */}
        <h1 className="text-4xl w-4/5 md:text-5xl lg:text-6xl 2xl:text-7xl font-bold font-gaegu text-center mt-16">
          Recap on Applications
        </h1>
        <h3 className="text-2xl md:text-4xl text-gray-500 font-nunito text-center z-10">
          Watch this 6-min recap video to recap what was taught for Applications.
        </h3>

        {/* Video */}
        <Iframe url={videoLink} height="300px" id="" className="w-340p lg:w-540p" />

        {/* Background Images */}
        <img
          src="/assets/apps/terminal-interface.png"
          alt="Terminal"
          className="w-1/4 md:w-1/6 lg:w-1/8 fixed top-0 right-0 translate-x-3/10"
        />
        <img
          src="/assets/apps/video.png"
          alt="Video"
