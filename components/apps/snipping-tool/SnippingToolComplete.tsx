...
export default function SnippingToolComplete({ updateCurrentElementIndex } : SnippingToolCompleteProps ){
  ...
  return ( <div className={`flex flex-col items-center justify-center min-h-screen py-2 bg-white space-y-12 lg:space-y-16 mt-10 md:mt-20 lg:mt-16 2xl:mt-0 opacity-0 transition-opacity ${
