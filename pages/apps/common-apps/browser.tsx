...
import BrowserTheory from "@/components/apps/browser/BrowserTheory";
import BrowserPractical from "@/components/apps/browser/BrowserPractical";
import BrowserComplete from "@/components/apps/browser/BrowserComplete";
...
export default function Browser() {
  ...
  return (
    <div>
        <Head>
        <title>Playground - Browser Application</title>
        </Head>
