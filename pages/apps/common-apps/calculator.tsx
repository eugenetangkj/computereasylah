...
import CalculatorTheory from "@/components/apps/calculator/CalculatorTheory";
import CalculatorPractical from "@/components/apps/calculator/CalculatorPractical";
import CalculatorComplete from "@/components/apps/calculator/CalculatorComplete";
...
export default function Calculator() {
  ...
  return (
    <div>
      <Head>
        <title>Playground - Calculator Application</title>
      </Head>
